<?php $title = "minimalistica"?>
<?php $h1 = "minimalistica"?>
...
<body>
	<div id="content">
		...
		<div id="footer">
			<p><span style="color:#ff0000;font-size:20px;"><?= date("Y")?></span> Copyright &copy; <em>minimalistica</em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a></p>
		</div>	
	</div>
</body>
</html>